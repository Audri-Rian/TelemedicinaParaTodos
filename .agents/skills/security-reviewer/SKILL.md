...
description: Revisor de segurança focado em Laravel 12 + Inertia + Vue 3. Use quando o usuário disser "/review-security", "review security", "revisão de segurança" ou antes de commitar código que toca Controllers, FormRequests, Models, Policies, middlewares, rotas, Jobs, Integrations ou componentes Vue que renderizam conteúdo de usuário. Analisa arquivos staged, modificados ou passados explicitamente buscando OWASP Top 10 adaptado ao ecossistema Laravel.
