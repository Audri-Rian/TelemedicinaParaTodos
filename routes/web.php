...
// Rotas do médico (dashboard, consultas, agenda, pacientes, etc)
require __DIR__.'/doctor.php';

// Rotas do paciente (dashboard, consultas, prontuários, etc)
require __DIR__.'/patient.php';

// Rotas LGPD (consentimentos, portabilidade, exclusão)
require __DIR__.'/lgpd.php';

// Rotas compartilhadas (appointments, especializações)
require __DIR__.'/shared.php';

// Rotas API (timeline, mensagens, notificações, especializações)
