...
// Videoconferência P2P removida; SFU em desenvolvimento — ver docs/videocall/
            ...
            <div class="flex flex-1 bg-gray-50">
                ...
                <div class="flex w-80 flex-col border-r border-gray-200 bg-white">
                    <div class="border-b border-gray-200 p-6">
                        ...
                        <p class="mt-1 text-sm text-gray-600">Selecione um médico para iniciar a consulta</p>
                    </div>
                ...
                <div class="flex flex-1 flex-col items-center justify-center bg-gray-50">
                    <div v-if="!selectedUser" class="text-center">
                        ...
                        <p class="mb-4 text-gray-600">Selecione um médico da lista ao lado para iniciar sua consulta</p>
                    ...
                    <div v-else class="max-w-md text-center">
                        ...
                        <div v-else class="mb-6 rounded-lg border border-yellow-200 bg-yellow-50 p-4">
                            ...
                            <p class="text-sm text-yellow-700">Você precisa ter um agendamento com este médico para iniciar a chamada.</p>
                        </div>
