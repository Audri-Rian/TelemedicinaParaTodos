    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-6 overflow-x-auto rounded-xl bg-gray-50 p-6">
            ...
            <div class="flex flex-col gap-4">
                <div>
                    <p class="text-sm font-semibold tracking-wide text-primary uppercase">Central do médico</p>
                    <h1 class="text-3xl font-bold text-gray-900">Pacientes acompanhados</h1>
                    <p class="text-sm text-gray-600">Visualize quem já passou em consulta e quem está agendado para os próximos dias.</p>
                </div>
                ...
                <div class="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
                    <div class="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <p class="text-xs text-gray-500 uppercase">Pacientes ativos</p>
                    ...
                    <div class="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <p class="text-xs text-gray-500 uppercase">Consultados nesta semana</p>
                    ...
                    <div class="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <p class="text-xs text-gray-500 uppercase">Consultas agendadas</p>
                    ...
                    <div class="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <p class="text-xs text-gray-500 uppercase">Total de pacientes</p>
            ...
            <div class="flex flex-col gap-4 rounded-2xl border border-gray-200 bg-white p-5 shadow-sm lg:flex-row lg:items-center lg:justify-between">
                <div class="flex flex-1 items-center gap-3">
                    <div class="relative flex-1">
                        ...
                        <Input v-model="searchQuery" type="text" placeholder="Buscar por nome do paciente..." class="pl-10" />
                    </div>
                ...
                <div class="flex flex-wrap items-center gap-2">
                    <button
                        ...
                        :class="[
                            ...
                            statusFilter === option ? 'bg-primary text-gray-900 shadow-sm' : 'bg-gray-100 text-gray-600 hover:bg-gray-200',
                        ]"
                    >
                    ...
                    >
                        ...
                        <div class="mt-4 space-y-2 rounded-xl bg-gray-50 p-4 text-sm">
                            <div class="flex items-center justify-between text-gray-700">
                                <span class="flex items-center gap-2 text-gray-500"> <Calendar class="h-4 w-4" /> Data </span>
                                <span class="font-semibold">{{ patient.scheduled_date || 'A confirmar' }}</span>
                            </div>
                            <div class="flex items-center justify-between text-gray-700">
                                <span class="flex items-center gap-2 text-gray-500"> <Clock class="h-4 w-4" /> Horário </span>
                                <span class="font-semibold">{{ patient.scheduled_time || patient.scheduled_date || '—' }}</span>
                            </div>
                            <div class="flex items-center justify-between text-gray-700">
                                <span class="flex items-center gap-2 text-gray-500"> <History class="h-4 w-4" /> Canal </span>
            ...
            <div v-if="filteredHistory.length" class="space-y-4">
                <div>
                    ...
                    <p class="text-sm text-gray-600">
                        Histórico de atendimentos recentes. Novos agendamentos são feitos pelo paciente na sua disponibilidade.
                    </p>
                </div>
                        ...
                        >
                            <div class="flex flex-1 items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500">Última consulta em {{ patient.lastConsultation || '—' }}</p>
                            ...
                            <div class="flex flex-1 flex-wrap items-center gap-3 text-sm text-gray-600">
                                <div class="flex flex-col">
                                    <span class="text-xs text-gray-400 uppercase">Próxima consulta</span>
                                    <span class="font-semibold text-gray-800">{{ patient.nextConsultation || 'Nenhuma agendada' }}</span>
                                </div>
                                <span
            ...
            <div
                v-if="!hasResults"
                class="flex flex-1 flex-col items-center justify-center rounded-2xl border border-dashed border-gray-300 bg-white/70 p-12 text-center"
            >
