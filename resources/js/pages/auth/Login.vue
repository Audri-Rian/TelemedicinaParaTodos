...
<template>
    <div class="relative min-h-svh flex flex-col items-center justify-center p-6 md:p-10">
        <Head title="Log in" />
        ...
        <div class="w-full max-w-sm md:max-w-3xl relative z-10">
            <div class="flex flex-col gap-6">
                <Card class="overflow-hidden p-0 bg-white/95 backdrop-blur-lg shadow-2xl border border-white/40">
                            ...
                            <div class="flex flex-col gap-6">
                                ...
                                <div class="grid gap-3">
                                    <div class="flex items-center">
                                        ...
                                        <TextLink v-if="canResetPassword" :href="request()" class="ml-auto text-sm underline-offset-2 hover:underline" :tabindex="3"> 
                                    ...
                                    >
                                        ...
                                        <AlertDescription>{{ getFieldError('password') }}</AlertDescription>
                                    </Alert>
                                </div>

                                <Button type="submit" class="w-full" :tabindex="4" :disabled="!canSubmit">
