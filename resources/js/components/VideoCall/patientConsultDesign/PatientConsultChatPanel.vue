    ...
    <div class="chat">
        <div class="chat-msgs">
            <div v-if="messages.length === 0" style="padding: 16px; text-align: center; color: var(--muted-foreground); font-size: 12.5px">
                Nenhuma mensagem ainda. As mensagens ficam salvas na conversa com o médico.
            </div>
        ...
        <div class="chat-input">
            <div class="field">
                <input v-model="draft" :placeholder="`Mensagem para ${doctorFirstName}…`" @keydown.enter.exact.prevent="send" />
            </div>
