...
Documento de referência: [IMPLEMENTACAO_SFU_MEDIASOUP.md](IMPLEMENTACAO_SFU_MEDIASOUP.md) e [Arquitetura_SFU_MediaSoup.md](../layers/domain/modules/videocall/Arquitetura_SFU_MediaSoup.md).
...
_Plano revisado com ajustes de arquitetura MediaSoup e melhorias para produção. Última atualização: março 2026._
