...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        if (!$doctor) {
            // Se não for médico, retornar dados básicos
    ...
    private function getWeeklyStats($doctorId)
    {
    ...
    private function getMonthlyStats($doctorId)
    {
    ...
    private function getWeeklyAppointmentsData($doctorId)
    {
        $startOfWeek = Carbon::now()->startOfWeek();
    ...
    private function getMonthlyAppointmentsData($doctorId)
    {
        $startOfMonth = Carbon::now()->startOfMonth();
        $weeks = ['S1', 'S2', 'S3', 'S4'];
        $data = [];
